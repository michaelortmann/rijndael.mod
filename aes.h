...
// IMPORTANT NOTE: BLOCK_SIZE is in BYTES (16, 24, 32 or undefined). If left
...
#if defined(BLOCK_SIZE) && BLOCK_SIZE != 16 && BLOCK_SIZE != 24 && BLOCK_SIZE != 32
...
public:            
    ...
    aes_ret ncrypt(const byte in_blk[], byte out_blk[]) const
            { return c_name(ncrypt)(in_blk, out_blk, &cx); }
